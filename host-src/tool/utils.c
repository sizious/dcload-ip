...
void log_error(const char *prefix) {
    ...
    if(dwError) {
        ...
        FormatMessageA(FORMAT_MESSAGE_ALLOCATE_BUFFER | FORMAT_MESSAGE_FROM_SYSTEM |
                       ...
                       NULL, dwError, MAKELANGID(LANG_NEUTRAL, SUBLANG_DEFAULT), (LPTSTR)&err, 0,
                       NULL);
...
void cleanup_ip_address(char *hostname) {
    ...
    int i = 0, j = 0, leading_zero = 1, has_value = 0;
...
const char *const exception_label_array[66] = {
    "PC  ", "PR  ", "SR  ", "GBR ", "VBR ", "DBR ", "MACH", "MACL", "R0B0", "R1B0", "R2B0",
    "R3B0", "R4B0", "R5B0", "R6B0", "R7B0", "R0B1", "R1B1", "R2B1", "R3B1", "R4B1", "R5B1",
    "R6B1", "R7B1", "R8  ", "R9  ", "R10 ", "R11 ", "R12 ", "R13 ", "R14 ", "R15 ", "FPSC",
    "FR0 ", "FR1 ", "FR2 ", "FR3 ", "FR4 ", "FR5 ", "FR6 ", "FR7 ", "FR8 ", "FR9 ", "FR10",
    "FR11", "FR12", "FR13", "FR14", "FR15", "FPUL", "XF0 ", "XF1 ", "XF2 ", "XF3 ", "XF4 ",
