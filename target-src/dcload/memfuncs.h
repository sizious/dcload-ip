...
static inline void CacheBlockWriteBack(unsigned char *__32_byte_base,
                                       unsigned int __32_byte_count) {
    unsigned int __32_byte_ptr = (unsigned int)__32_byte_base;
...
static inline void CacheBlockInvalidate(unsigned char *__32_byte_base,
                                        unsigned int __32_byte_count) {
    unsigned int __32_byte_ptr = (unsigned int)__32_byte_base;
